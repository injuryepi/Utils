...
get_ed_opi <- function(username, password, start_date, end_date, version = 2, site_no = 934, user_id = 515, ...) {
  ...
  url <- "https://essence.syndromicsurveillance.org/nssp_essence/api/dataDetails?endDate=4Jul2018&ccddCategory=cdc%20opioid%20overdose%20v2&percentParam=noPercent&geographySystem=hospital&datasource=va_hosp&detector=nodetectordetector&startDate=4Jul2018&timeResolution=daily&hasBeenE=1&medicalGroupingSystem=essencesyndromes&userId=000&site=000&hospFacilityType=emergency%20care&aqtTarget=DataDetails"
